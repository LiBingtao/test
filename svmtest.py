...
train_target = np.loadtxt('C:/Users/Bingtao LI/PycharmProjects/text/train_target3.csv', delimiter=",", skiprows=0)
...
test_target= np.loadtxt('C:/Users/Bingtao LI/PycharmProjects/text/test_target3.csv', delimiter=",", skiprows=0)
test_target.reshape(1,-1)

lala = svm.SVC(kernel='poly',degree=2, decision_function_shape='ovr')
